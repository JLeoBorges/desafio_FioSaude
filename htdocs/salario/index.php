...
<ul class="nav nav-pills">
  ...
  <li role="presentation" class="active"><a href="/salario/index.php">Salário</a></li>
...
<div class="container">
	...
	<span style="font-size:25px; color:blue"><center><strong>Salário</strong></center></span>	
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<?php
				...
				$query=mysqli_query($conn,"select * from salarios");
