    ...
    <div class="modal fade" id="del<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<?php
					$del=mysqli_query($conn,"select * from projetos where id='".$row['id']."'");
					$drow=mysqli_fetch_array($del);
				?>
				<div class="container-fluid">
					<h5><center>Você têm certeza que quer excluir <strong><?php echo ucwords($drow['nome']); ?></strong> da lista? isso não poderá ser desfeito.</center></h5> 
                </div> 
				</div>
    ...
    <div class="modal fade" id="edit<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
				<?php
					$edit=mysqli_query($conn,"select * from projetos where id='".$row['id']."'");
				...
				<form method="POST" action="edit.php?id=<?php echo $erow['id']; ?>">
					...
					<div class="row">
						<div class="col-lg-2">
							<label class="control-label" style="position:relative; top:7px;">Descrição do Projeto:</label>
						</div>
						<div class="col-lg-10">
							<input type="text" class="form-control" name="descricao" value="<?php echo $erow['descricao']; ?>">
						</div>
					</div>
					<div style="height:10px;"></div>
                </div> 
