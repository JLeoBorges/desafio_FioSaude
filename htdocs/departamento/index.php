...
<ul class="nav nav-pills">
  ...
  <li role="presentation" class="active"><a href="/departamento/index.php">Departamento</a></li>
</ul>
<div class="container">
	<div style="height:50px;"></div>
	<div class="well" style="margin:auto; padding:auto; width:80%;">
	<span style="font-size:25px; color:blue"><center><strong>Cadastro de Departamentos</strong></center></span>	
